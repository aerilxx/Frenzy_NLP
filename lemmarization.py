...
def create_brand_dictionary():
    ...
    conn = pymysql.connect(host='http://frenzystaging.cimjunfbcdxs.us-west-1.rds.amazonaws.com/',
                             user='frenzylive',
                             port = 8889,
                             passwd='bhxJ6V1B',
                             db='ebdb')
...
def create_brandname_dictionary():
    ...
    try:
        with conn.cursor() as cursor:
            sql = " SELECT brandname AS old_brand, brandname AS new_brand FROM BrandNew"
